...
export default function todoRouter() {
    ...
    return(
        <Route path='/todo' element={<TodoIndexPage/>}>
            ...
            <Route path={'list'} element={<Suspense fallback={Loading}> <TodoList/> </Suspense>}></Route>,
            <Route path={'add'} element={<Suspense fallback={Loading}> <TodoAdd/> </Suspense>}></Route>,
            <Route path={'read/:tno'} element={<Suspense fallback={Loading}> <TodoRead/> </Suspense>}></Route>,
            <Route path={'modify/:tno'} element={<Suspense fallback={Loading}> <TodoModify/> </Suspense>}></Route>,
        </Route>
    )
}